...
`,h=a.div`
  ...
  animation-delay: ${e=>e.delay}s;
  user-select: none;
`,g=t.memo(function(){return o.jsxs(f,{children:[[{size:20,left:10,top:20,delay:0},{size:15,left:80,top:30,delay:.5},{size:25,left:20,top:70,delay:1},{size:18,left:70,top:80,delay:1.5},{size:22,left:50,top:10,delay:2}].map((e,t)=>o.jsx(u,{size:e.size,left:e.left,top:e.top,delay:e.delay},`element-${t}`)),[{symbol:"<div>",left:15,top:40,delay:.2},{symbol:"CSS",left:85,top:60,delay:.8},{symbol:"JS",left:75,top:15,delay:1.8},{symbol:"TS",left:40,top:25,delay:2.2},{symbol:"<JSX>",left:60,top:75,delay:2.6},{symbol:"[]",left:90,top:40,delay:3},{symbol:"()",left:25,top:60,delay:3.4}].map((e,t)=>o.jsx(h,{left:e.left,top:e.top,delay:e.delay,children:e.symbol},`symbol-${t}`))]})}),y=t.lazy(()=>i(()=>import("./ParticlesBackground-D-DCFDtQ.js"),__vite__mapDeps([0,1,2]))),x=a.div`
  min-height: 100vh;
  display: flex;
