...
function Contact({
  email = 'dariusz.berer@example.com', // Replace with your actual email
  phone = '+48 123 456 789', // Replace with your actual phone
  linkedin = 'https://linkedin.com/in/dariusz-berer', // Replace with your actual LinkedIn
  github = 'https://github.com/Dariuszb94', // Your actual GitHub
}: ContactProps) {
  return (
    <ContactSection>
      <ContactHeader>
